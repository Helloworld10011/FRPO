...
from sam_trainer import SAMGRPOTrainer, SAMGRPOConfig
...
model_id = "/home/ubuntu/Models/mistralai/Mistral-7B-Instruct-v0.1"

output_dir = f"/home/ubuntu/Models/RL/{args_cli.exp}"
exp_name = f"{args_cli.exp}"

# 1) Build a simple "prompt" dataset from preference data
df = pd.read_parquet("/home/ubuntu/Training/FT/train_lambda_0.5.parquet")
...
SR = StrongReject("/home/ubuntu/Models/qylu4156/strongreject-15k-v1")
RE = RM("allenai/Llama-3.1-8B-Instruct-RM-RB2")
...
args = SAMGRPOConfig(
    deepspeed= "/home/ubuntu/LLaMA-Factory/examples/deepspeed/ds_z2_config.json",
