...
output_dir = f"{args_cli.output_dir_base}/{args_cli.exp}_la:{args_cli.lamb}"
exp_name = f"{args_cli.exp}_la:{args_cli.lamb}_be:{args_cli.beta}"
...
args = FRPOConfig(
    ...
    steps_per_generation=1, ####Important: for FRPO we need all the prompts within a group to be processed together.
    max_grad_norm=1.0,
    weight_decay=0.1, ### To aoid overfitting on the small dataset. For Qwen use 0.0001 instead.
